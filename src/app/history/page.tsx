...
export default function HistoryPage() {
  ...
  const grouped = useMemo(() => {
    ...
    for (const a of activities) {
      if (
        a.recordSource === 'historical_confirmation' ||
  ...
  return (
    <>
      <header className="px-3 pt-2 pb-3 flex items-center gap-2">
        ...
        <h1 className="font-semibold text-stone-700">当日履歴</h1>
        <button
          type="button"
          onClick={handleCopy}
          disabled={!hydrated || grouped.length === 0}
